package com.example.shortnotes.Apapters;
...
import com.example.shortnotes.NotesClickListener;
...
NotesClickListener listener ;
 ...
 holder.textView_tittle.setText(list.get(position).getTitle());
...
ImageView imageView_pin;
    ...
    public NotesViewHolder(@NonNull View itemView) {
        ...
        textView_tittle = itemView.findViewById(R.id.textView_title);
